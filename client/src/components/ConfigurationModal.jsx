...
export default function ConfigurationModal(_a) {
  ...
  useEffect(
    function () {
      ...
      if (businessRules && isOpen) {
        setRules({
          mail:
            (_a = businessRules.mail) !== null && _a !== void 0
              ? _a
              : { maxWeight: 1.0 },
          regular:
            (_b = businessRules.regular) !== null && _b !== void 0
              ? _b
              : { maxWeight: 10.0 },
          heavy:
            (_c = businessRules.heavy) !== null && _c !== void 0
              ? _c
              : { minWeight: 10.0 },
          insurance:
            (_d = businessRules.insurance) !== null && _d !== void 0
              ? _d
              : { minValue: 1000.0, enabled: true },
        });
      }
    },
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                apiRequest("PUT", "/api/business-rules", newRules),
              ];
            case 1:
  ...
  var updateMailWeight = function (value) {
    ...
    if (!isNaN(numValue) && numValue > 0)
      setRules(function (prev) {
        return __assign(__assign({}, prev), { mail: { maxWeight: numValue } });
      });
  };
  ...
  var updateHeavyWeight = function (value) {
    ...
    if (!isNaN(numValue) && numValue > 0) {
      setRules(function (prev) {
        return __assign(__assign({}, prev), { heavy: { minWeight: numValue } });
      });
    }
  };
  var updateInsuranceValue = function (value) {
    ...
    if (!isNaN(numValue) && numValue >= 0)
      setRules(function (prev) {
        return __assign(__assign({}, prev), {
          insurance: __assign(__assign({}, prev.insurance), {
            minValue: numValue,
          }),
        });
      });
  };
  var toggleInsuranceEnabled = function (enabled) {
    return setRules(function (prev) {
      return __assign(__assign({}, prev), {
        insurance: __assign(__assign({}, prev.insurance), { enabled: enabled }),
      });
    });
  };
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        data-testid="modal-configuration"
      >
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-4">
              Weight-based Department Routing
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Input
                    type="number"
                    value={rules.mail.maxWeight}
                    step="0.1"
                    min="0.1"
                    onChange={function (e) {
                      return updateMailWeight(e.target.value);
                    }}
                    className="flex-1"
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Input
                    type="number"
                    value={rules.regular.maxWeight}
                    step="0.1"
                    min="0.1"
                    onChange={function (e) {
                      return updateRegularWeight(e.target.value);
                    }}
                    className="flex-1"
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Input
                    type="number"
                    value={rules.heavy.minWeight}
                    step="0.1"
                    min="0.1"
                    onChange={function (e) {
                      return updateHeavyWeight(e.target.value);
                    }}
                    className="flex-1"
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-4">
              Value-based Insurance Requirements
            </h4>
            <div className="flex items-center space-x-4">
              <div className="flex-1">
                <Label className="text-sm font-medium text-foreground">
                  Insurance Review Threshold
                </Label>
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <Input
                    type="number"
                    value={rules.insurance.minValue}
                    step="100"
                    min="0"
                    onChange={function (e) {
                      return updateInsuranceValue(e.target.value);
                    }}
                    className="flex-1"
